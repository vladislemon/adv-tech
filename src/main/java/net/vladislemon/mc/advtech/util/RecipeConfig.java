...
public class RecipeConfig {
    ...
    public EncodedString getEncodedString(String name, EncodedString defaultValue) {
        return (EncodedString) getEntry(name, EncodedString.class, defaultValue).value;
    }

    public EncodedString getEncodedString(String name) {
        return getEncodedString(name, new EncodedString(""));
    }
    ...
    public void setEncodedString(String name, EncodedString value) {
        setEntry(name, new Entry(EncodedString.class, value));
    }
    ...
    public static String getNameByType(Class type) {
        ...
        if (array[array.length - 1].equals("String")) {
            ...
            return "F";
        } else if (array[array.length - 1].equals("EncodedString")) {
            return "E";
        }
        return null;
    }
